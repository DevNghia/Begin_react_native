    ...
    <View style={styles.container}>
      <View
        ...
        <View>
          ...
          /> */}
           <Icon name="payments" size={45} color="#04962D"  style={styles.icon} />
        ...
        <View>
        <Icon name="article" size={45} color="#08DCEA"  style={styles.icon} />
      ...
      <View
        ...
        <View>
        <Icon name="photo-album" size={45} color="#EF0606"  style={styles.icon} />
          <Text style={styles.textIcon}>Albums</Text>
        </View>
        </TouchableOpacity >
        <TouchableOpacity  onPress={() => navigation.navigate('DichVu')}>
        <View>
        <Icon name="home-repair-service" size={45} color="black"  style={styles.icon} />
          <Text style={styles.textIcon}>Dịch Vụ</Text>
        </View>
        </TouchableOpacity>
        <TouchableOpacity  onPress={() => navigation.navigate('DanhGia')}>
        <View>
        <Icon name="assessment" size={45} color="#8F14C9"  style={styles.icon} />

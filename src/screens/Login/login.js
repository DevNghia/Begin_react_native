...
import { View, Text,Input, StyleSheet, Image, SafeAreaView, Dimensions, TextInput,TouchableOpacity } from 'react-native';
...
/>
      ...
      <AppButton onPress={handleSubmit(onSubmit)} disabled={submiting} title="Login" size="sm" />
    </View>
